        ...
        n = {
                ...
                h = i(
                  [
                    ...
                    '<div class="' +
                      ...
                      '" ' +
                      (y ? '' : 'readonly') +
                      ' class="layui-input layui-unselect3' +
                      (u ? ' ' + c : '') +
                      '">',
          ...
          radio: function() {
            ...
            a.each(function(a, l) {
              ...
              var u = i(
                [
                  '<div class="layui-unselect ceshi' +
                    l.title +
                    '   ' +
                    e +
                    (l.checked ? ' ' + e + 'ed' : '') +
